...
\begin{abstract}
	There have been remarkable advancements in the automobile industry the last century.
	Along with the progress in computation and communication development, Real Time Operation Systems (RTOS) allows
	implementation of a vast set of technologies. RADAR, LIDAR, GPS and AI are some of them.
	Also, autonomous vehicles (AV) are becomming a reality. Safety, optimal trafficflow and ease of travel are among
	some of the aspects AV's are forseen to cover. With the development of AV's comes ethical challanges and questions
	which are unavoidable. We propose that such matters should be integrated in the development rather than impeding it.
	United Nations Economic Commission for Europe (UNECE) has, as of this year (2020), made regulations that will allow for safer introduction for AV’s
	in certain traffic situastions. They have made a regulation where strict requirements are give for Automated Lane Keeping Systems (ALKS) and
	the current level for AV's is now at three. This leads us to think that AV's and similar types of landbased vehicles are not far fetched in the
	near future.
\end{abstract}
