...
% # IN PROGRESS: Maskin Læring
 \subsection{Machine learning}
	Machine learning (ML) is a subset of artificial intelligence and by definition is "the study of 
	computer algorithms that improves automaticcaly through experience". %\cite{wikopedia:ML}. 
	...
	\begin{enumerate}
		...
		\end{itemize}
		%\cite{towardsDataSience:supervised}
		%url https://towardsdatascience.com/a-brief-introduction-to-supervised-learning-54a3e3932590
...
\section{Implementation of AI in AV's} % # IN PROGRESS: Make title
