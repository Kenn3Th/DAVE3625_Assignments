...
% # IN PROGRESS: Maskin Læring
 \subsection{Machine learning}
	...
	\begin{enumerate}
		...
		the data structure in big datasets with no labels \cite{deepAI:UL}. The most used algorithm used in unsupervised learing is cluster analysis \cite{wiki:UL}. 
