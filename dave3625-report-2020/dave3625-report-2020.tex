...
\subsection{Implementation}
 ...
 \subsection{Ethics}
	...
	\subsubsection{Decisions}
		...
		We should not discard these kinds of problems all togehter. It is very important to have in mind when developing AV technology. We should not limit the
		vehicle binary choices but rather multiple decision to choose from. Then look for the optimal solution in statistics. With this a statistical outcome we as
		a society have to consider how we want to distribuate the fatalities between the passengers and pedestrians.
